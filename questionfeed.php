...
<head>
  ...
  <link href="./assets/css/sidebar.css" rel="stylesheet" />
    ...
    <style>
      ...
      /* Ensure question text and options are clearly visible */
      .question-form .question-editor,
                ...
                <div class="col-md-8 tab-content-pane">
                  <div class="tab-content">
                      <div class="tab-pane <?php echo $active1;?>" id="tab1">
                        <form name="typea" class="question-form" action="<?php echo $form_action; ?>" method="post">
                          <div class="responsive-form-container">
                            <?php echo $hidden_action_field; ?>
                            <input type="hidden" name="type" value="a"/>
                            <div class="form-group question-field">
                              <label>Question</label>
                              <div class="form-control question-editor" contenteditable="true" style="min-height:100px;"><?php echo $question_text; ?></div>
                              <input type="hidden" name="question">
                              <div class="mt-2">
                                <button type="button" class="btn btn-sm btn-secondary" onclick="formatDoc('superscript', this)">x<sup>2</sup></button>
                                <button type="button" class="btn btn-sm btn-secondary" onclick="formatDoc('subscript', this)">X<sub>2</sub></button>
                              </div>
                            </div>
      ...
      document.getElementById('mcq_file').addEventListener('change', function () {
        ...
        info.textContent = this.files.length ? 'Selected file: ' + this.files[0].name : 'No file selected';
                      ...
                      <div class="tab-pane <?php echo $active3;?>" id="tab3">
                        <form name="typec" class="question-form" action="<?php echo $form_action; ?>" method="post">
                          <div class="responsive-form-container">
                            <?php echo $hidden_action_field; ?>
                      ...
                      <div class="tab-pane <?php echo $active4;?>" id="tab4">
                        <form name="typed" class="question-form" action="<?php echo $form_action; ?>" method="post">
                          <div class="responsive-form-container">
                            <?php echo $hidden_action_field; ?>
                      ...
                      <div class="tab-pane <?php echo $active5;?>" id="tab5">
                        <form name="typee" class="question-form" action="<?php echo $form_action; ?>" method="post">
                          <div class="responsive-form-container">
                            <?php echo $hidden_action_field; ?>
                      ...
                      <div class="tab-pane <?php echo $active6;?>" id="tab6">
                        <form name="typef" class="question-form" action="<?php echo $form_action; ?>" method="post">
                          <div class="responsive-form-container">
                            <?php echo $hidden_action_field; ?>
  ...
  <script>
    function formatDoc(cmd, button) {
      var editor = button.closest('.question-field').querySelector('.question-editor');
      editor.focus();
    ...
    document.querySelectorAll('.question-form').forEach(function(form){
      form.addEventListener('submit', function(e){
        ...
        if(editor){
          ...
          var hidden = form.querySelector('input[name="question"]');
